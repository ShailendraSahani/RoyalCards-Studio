    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-100 py-16">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-gray-800 text-center mb-8">Shipping Options</h2>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-gray-800 text-center mb-8">Delivery Areas</h2>
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-sm font-semibold text-gray-800">Pincode Range</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  {deliveryAreas.map((area, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      <td className="px-6 py-4 text-sm text-gray-800 font-medium">{area.city}</td>
                      <td className="px-6 py-4 text-sm text-gray-600">{area.pincode}</td>
                      <td className="px-6 py-4 text-sm text-gray-600">{area.time}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-gray-800 text-center mb-8">Shipping Policy</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              <h3 className="text-xl font-bold text-gray-800 mb-4">🚚 Delivery & Returns</h3>
              <ul className="space-y-3 text-gray-600">
        ...
        >
          <div className="bg-gradient-to-r from-rose-500 to-yellow-500 rounded-xl shadow-lg p-8 text-white max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="mailto:shipping@shaadicards.com"
